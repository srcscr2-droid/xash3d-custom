...
extern	convar_t		*sv_hitbox_expand;	// absolute hitbox expansion in world units
extern	convar_t		*default_hitbox;	// 0=full visual hull, 1=legacy per-bone (needs restart)

// sv_direct.c — public P2P listen server with STUN + UPnP

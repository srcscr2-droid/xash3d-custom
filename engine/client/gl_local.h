...
typedef struct
{
	int		width, height;		// internal render resolution (may be scaled)
	int		screenWidth, screenHeight;	// physical display/surface resolution
	qboolean		fullScreen;
	qboolean		wideScreen;
	...
	qboolean		in2DMode;
	int			renderMode;	// current kRenderXxx mode, -1 = unknown/reset
} glstate_t;
